...
const RESEARCH_ORGS = {
  ...
  "orgs": {
    ...
    "TEHILA": {
      ...
      "school_count": 0,
      "program_budget": 0,
      "thesis": "ארגון המפעיל סדנאות בנושא זהות מגדרית בבתי ספר. הכניסה מתבצעת דרך אגפי בריאות עירוניים ולא דרך אגפי חינוך. פריסה ב-10+ ערים. חבר בקואליציית OHCHR יחד עם חוש\"ן.",
      "key_findings": [
        "מנכ\"לית: עפירת רותם",
    ...
    "CASEL_INTL": {
      ...
      "school_count": 8000,
      "program_budget": 0,
      "thesis": "ארגון הגג הגלובלי ל-SEL. הכנסות $12M (2022). ב-2020 עדכן את המסגרת ל-'Transformative SEL' הכוללת equity וצדק חברתי. Schusterman מממנת גם CASEL וגם אבני ראשה. אין שותפות ישראלית מוצהרת.",
      "key_findings": [
        "EIN: 20-5884201. הכנסות: $12M (2022), $11M (2021), $9M (2020)",
        "מממנים: Wallace ($2.5M), Gates ($2M), CZI ($1.5M), Einhorn ($1M), NoVo ($750K), Ford ($500K)",
        "Transformative SEL (2020): הוספת equity, צדק חברתי, זהות, תודעה ביקורתית, שינוי מערכתי",
        "7 מדינות אמריקאיות הגבילו SEL בחקיקה: פלורידה, טקסס, ארקנסו, איווה, מונטנה, צ' קרולינה, דרום קרולינה",
        "אין שותפות ישראלית מוצהרת. Schusterman מממנת CASEL וגם אבני ראשה"
      ],
      "risk": "high",
    ...
    "NIF": {
      ...
      "school_count": 0,
      "program_budget": 0,
      "thesis": "קרן אמריקאית למימון חברה אזרחית בישראל. מממנת ארגונים הפועלים בחינוך: ACRI ($1M/שנה), חוש\"ן ($15K), B'Tselem ($400K), סיכוי ($150K). שתיל — זרוע הפעלתית, 3 סניפים.",
      "key_findings": [
        "ACRI: $1,000,000/שנה (2020-2022). ACRI מפעילה תוכניות חינוך לזכויות אדם בבתי ספר",
        "B'Tselem: $400,000 (2022)",
        "סיכוי: $150,000 (2022)",
        "חוש\"ן: $15,000 (2019)",
        "שתיל (זרוע הפעלתית): ייעוץ אסטרטגי, פיתוח ארגוני, בניית קואליציות. סניפים: ת\"א, ירושלים, נצרת",
        "קואליציית OHCHR (UPR 2023): רוב חברי הקואליציה מקבלים מימון NIF"
      ],
      "risk": "high",
    ...
    "MOE_SEL": {
      ...
      "school_count": 0,
      "program_budget": 0,
      "thesis": "המונח SEL אינו מופיע בחוזרי מנכ\"ל. תכנים רגשיים-חברתיים מוטמעים תחת מונחים עבריים: 'אקלים חינוכי מיטבי', 'כישורי חיים', 'חינוך חברתי'. שלושה חוזרי מנכ\"ל מרכזיים מנדטים תוכן רגשי-חברתי.",
      "key_findings": [
        ...
        "CASEL, אבני ראשה, SEL — אף אחד מהם לא מוזכר בחוזרי מנכ\"ל",
